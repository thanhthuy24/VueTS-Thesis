    ...
    >
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          <li>
            <router-link :to="{ name: 'course-detail-teacher', params: { courseId: courseId } }">
              <a
                href="#"
              ...
              >
                ...
                <span class="ms-3">Course Detail</span>
              </a>
            </router-link>
          </li>
          <li>
            <router-link to="/admin/teacher-list-admin">
              <a
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Rates</span>
          ...
          <li>
            <RouterLink :to="{ name: 'assignment-list-teacher', params: { courseId: courseId } }">
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Assignment</span>
              </a>
            </RouterLink>
          </li>
        </ul>
